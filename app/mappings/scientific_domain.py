...
scientific_domains_mapping = {
    ...
    "animal viral diseases/swine diseases": (
        "Medical & Health Sciences>Veterinary Sciences"
    ),
...
sd_training_temp_mapping = {
    ...
    "agricultural_sciences-agricultural_biotechnology": (
        "Agricultural Sciences>Agricultural Biotechnology"
    ),
    ...
    "engineering_and_technology-civil_engineering": (
        "Engineering & Technology>Civil Engineering"
    ),
    ...
    "humanities-philosophy_ethics_and_religion": (
        "Humanities>Philosophy, Ethics & Religion"
    ),
